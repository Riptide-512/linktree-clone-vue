...
`,
  project: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.25 6.75 22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3-4.5 16.5"></path>`,
}
</script>
...
<template>
  <a
    ...
    class="group relative flex w-full items-center gap-4 rounded-xl border border-gray-700 bg-gray-800 p-4 shadow-md shadow-gray-900/50 transition-all duration-300 hover:scale-[1.02] hover:border-green-700 hover:shadow-xl hover:shadow-green-500/20"
  >
    <!-- Icon Container-->
    <div
    ...
    <!--Hover glow Effect-->
    <div
      class="absolute inset-0 rounded-xl bg-linear-to-r from-green-500/0 via-green-500/20 to-green-500/0 opacity-0 transition-opacity duration-300 group-hover:opacity-100"
    />
  </a>
</template>
